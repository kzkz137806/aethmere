...
| 产品快照 | 目标画像证据成熟度 |
|---|---:|
| Aethmere（2026-08-25 快照） | 68.75 |
| Graphiti 0.29.3 | 41.50 |
| Letta Code 0.30.29 | 21.00 |
| Mem0 2.0.18 | 36.50 |
| MemOS 2.0.31 | 39.75 |

证据资格状态为：项目自身证据 17/18、同行隔离证据 6/18、独立复现证据 0/18、行业领先证据 0/18。可直接对齐的切片中，Aethmere 生命周期为 6/6、冻结检索为 10/10、1/8/32 容量为 150/150、严格持续运行完成 7,500/7,500 并通过；其他产品各有通过、未支持或时序门未通过的情况。版本、逐项结果与不可外推边界见 [EVALUATION.md](EVALUATION.md)。
